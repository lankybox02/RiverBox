function loadAdminTools() {
  if (admin == 'true') {
    ...
    document.getElementById("navbar").insertAdjacentHTML("afterEnd", `<div style="background-color: rgba(0, 0, 0, 0.4);display: inline-block;padding: 10px;border-bottom-right-radius: 20px;position: fixed;left: 0;z-index:2;"><details id="adminDropdown"><summary style="cursor:pointer">Admin Tools</summary><span class="header">Admin Tools</span><br><input placeholder="Modal name..." autocomplete="off" id="modalinput"><br><input placeholder="Page name..." autocomplete="off" id="pageinput"><br><input placeholder="Username..." id="userinput"><br><input placeholder="Community ID..." autocomplete="off" id="communityinput"></details></div>`);
